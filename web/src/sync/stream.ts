...
// audit §6a). Imported here for the internal callers (fetchMessagePage /
// fetchSessionMessages / the Stream-1 + Stream-2 snapshot/batch listeners /
// expandTreeNode); the two public decoders are re-exported below to preserve
// the module's existing public API that unit tests import directly.
import { decodeGzip64, decodeMessagesBatch, decodeSnapshot } from "./decode";
