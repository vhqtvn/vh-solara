...
//
//	validatedAgainst = "opencode v1.18.14"
//
// (sst/opencode tag v1.18.14). Source citations live in
...
const (
	...
	opencodeValidatedTag   = "opencode v1.18.14"
...
// Captured v1.18.14 session-table contract the unarchive UPDATE depends on.
// Source: packages/core/src/session/sql.ts @ v1.18.14 (SessionTable).
...
// captured v1.18.14 contract (renamed column/table, retyped column, added NOT
...
// fallbackDBPath re-implements OpenCode's Database.path() (v1.18.14) in Go. It
...
// it introspects the live DB and asserts the captured v1.18.14 contract holds:
